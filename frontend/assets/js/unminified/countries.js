    ...
    var m = !0,
        ...
        e = function(a) {
            if ("true" !== a.getAttribute("data-crs-loaded")) {
                ...
                for (var t = b(a), s = 0; s < t.length; s++) {
        ...
        M = function(a) {
            var n = a.getAttribute("data-blank-option"),
                e = n || "-",
                i = a.getAttribute("data-show-default-option");
            u = null === i || "true" === i, a.length = 0, u && (a.options[0] = new Option(e, ""), a.selectedIndex = 0)
        },
        B = function() {
        ...
        c = function(a, n) {
            ...
            if ("" === a.value) M(n);
                ...
                n.length = 0, u && (n.options[0] = new Option(o, ""));
                for (var l = b(a)[e][3], t = 0; t < l.regions.length; t++) {
                    var s = "shortcode" === r && l.hasShortcodes ? l.regions[t][1] : l.regions[t][0];
                    n.options[n.length] = new Option(l.regions[t][0], s)
                }
                n.selectedIndex = 0
            }
        },
...
jQuery("#country").change(function() {
    if (jQuery(this).val() === "US") {
            ...
            jQuery("#zipcode").prop("required", false);
    }
});